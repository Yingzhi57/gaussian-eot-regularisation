# Build the allocation--covariance figure and summary table from saved Gaussian
# records and dense-mesh reference curves. No simulations are rerun. The line
# at rho=11 displays the local known-basis reference used in the report.
# Run: python summary_332.py
...
# Plot risk gains and multiplier selection across allocations.
