# Balanced Gaussian benchmark for the full-matrix RBPB decision rule.
# Independent reference datasets estimate the best common multiplier on a
# dense mesh. Fresh evaluation datasets compare no regularisation, the local
# known-basis comparator, the dense-mesh reference and RBPB using exact affine
# population loss. Separate seeds control geometry, data and bootstrap draws.
# The evaluation extends to 10,000 replications only when the paired RBPB-to-
# zero risk-ratio MCSE exceeds 0.002.
...
# Case 1: balanced, five-dimensional, non-commuting covariance pair.
CELLS = [
