# table_331.py
# Overleaf table for Section 3.3.1: reads the three benchmark runs
# (G1, G2a, G2b) and writes table_331.tex in the agreed layout:
# case rows, m_dense/m_grid, the three risk ratios with paired
# delta-method standard errors in parentheses, and the RBPB selection
# median with interquartile range. Needs \usepackage{booktabs}.
# Run in the folder with all six output files:  python table_331.py
