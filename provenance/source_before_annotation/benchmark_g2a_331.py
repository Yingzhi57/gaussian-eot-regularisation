# benchmark_331_g2a.py — scenario variant of benchmark_331.py
#   d = 5, n1 = n2 = 50 (small-sample check); everything else identical: protocol, roots,
...
# G2a: cell index 1 keeps its seed namespace disjoint from G1
CELLS = [
