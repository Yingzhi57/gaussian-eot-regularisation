# benchmark_331_g2b.py — scenario variant of benchmark_331.py
#   d = 10, n1 = n2 = 100 (dimension check); everything else identical: protocol, roots,
#   GEOM_ROOT geometry seeding, dense mesh, policies, extension rule.
...
# G2b: cell index 2 keeps its seed namespace disjoint from G1
CELLS = [
